...
_page("SELECT id FROM tbl_babylon_wealth",10);
$_result = $mysqli->_query("SELECT id,income_date,income_account,income_item,income_amount,account_balance FROM tbl_babylon_wealth ORDER BY id ASC LIMIT $_pagenum,$_pagesize");
?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div id="pad-wrapper" class="users-list">
                <div class="row-fluid header">
                    ...
                    <div class="span10 pull-right">
                        <a href="new-babylon-wealth.php" class="btn-flat success pull-right">
                            <span>&#43;</span>
                            	新增
                        </a>
                    </div>
