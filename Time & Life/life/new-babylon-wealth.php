            ...
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            <form class="new_user_form normal-input" action="mis.php?action=new_babylon_wealth" method="post" />
                                ...
                                <div class="span12 field-box">
                                    ...
                                    <select style="width:74.35897435897436%" class="select2" name="income_account">
	                                    ...
	                                    <option value="6228 4804 0117 6449 015（农业银行-苏州）" selected="" />6228 4804 0117 6449 015（农业银行-苏州）
	                                    <option value="6221 7302 1701 0211 826（江苏银行-苏州）" />6221 7302 1701 0211 826（江苏银行-苏州）
	                                </select>
                                </div>
                                <div class="span12 field-box">
                                    <label>入账项目:</label>
                                    <select style="width:74.35897435897436%" class="select2" name="income_item">
	                                    ...
	                                    <option value="工资固定划入（10%）" selected="" />工资固定划入（10%）
	                                    <option value="工资固定划入（20%）" />工资固定划入（20%）
