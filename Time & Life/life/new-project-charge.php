            ...
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            <form class="new_user_form normal-input" action="mis.php?action=new_project_charge" method="post" />
                                <div class="span12 field-box">
                                    <label>项目名称:</label>
                                    <input class="span9" type="text" name="project_name" placeholder="请填写项目名称..." />
                                </div>
                                <div class="span12 field-box">
                                    <label>项目开始时间:</label>
                                    <input type="text" class="span9 datepicker" name="project_begin_date" />
                                </div>
                                <div class="span12 field-box">
                                    <label>项目结束时间:</label>
                                    <input type="text" class="span9 datepicker" name="project_end_date" />
                                </div>
                                <div class="span12 field-box">
                                    <label>收入账户:</label>
                                ...
                                <div class="span12 field-box">
                                    ...
                                    <div class="input-append">
                                    	<input class="span9" type="text" name="project_charge" />
