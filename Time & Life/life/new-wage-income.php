            ...
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            <form class="new_user_form normal-input" action="mis.php?action=new_wage_income" method="post" />
                                ...
                                <div class="span12 field-box">
                                    ...
                                    <select style="width:74.35897435897436%" class="select2" name="income_account">
	                                    ...
	                                    <option value="6217 0012 1004 5194 204（建设银行-上海）" selected="" />6217 0012 1004 5194 204（建设银行-上海）
